# javascript-lawn-mover (ES-6)

This shows a simple UI for a JS lawn mover with in a defined limit.
...
# Requirements
Any browser that supports ES6 Javascript.
All the instructions are case sensitive.
Specify the maximum X and Y coordinates.

Eg: Input instructions: 

1 2 N ---> initial coordinates and orientation
LFLFLFLFF ----> instructions for movement


Output: 

1 3 N ----> final coordinates and orientation after the command executed.
